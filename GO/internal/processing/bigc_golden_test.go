...
// into one of three evidence-backed categories (see task-8-report.md for
...
//
//  3. "live-CSV-snapshot newline skew" (71 entries, column AQ only):
//     BigC's promo values come from a live Google Sheets CSV export
//     (find_all_promotions_by_sku_and_time, xulydonhang.py:5648, via
//     pd.read_csv(sheet_url, ...)), fetched fresh on every call, with NO
//     normalization applied to cell values (unlike headers, which do get
//     .replace("\n"," ").replace("\r","")) — xulydonhang.py:5723,
//     df.at[sku_row_idx, col], used completely raw. Task 7's real
//     fixtures and this test's frozen _frozen_pricing.json snapshot
//     (bigc/testdata/fixtures/_frozen_pricing.json) are TWO INDEPENDENT
//     live fetches of the same editable sheet, captured at different
//     times, via the exact same pd.read_csv(url, dtype=str,
//     header=None) call. All 71 mismatches are the identical promo text
//     ("Giảm giá 15%") differing ONLY in trailing whitespace/newline
//     representation (" \r" vs " \n", or "\r\n" vs "\n\n") — confirmed
//     by inspecting raw_rows directly: even WITHIN one single frozen
//     snapshot, visually-identical "Giảm giá 15%" promo cells across
//     different SKU rows show several different embedded-newline
//     variants, proving this is inherent per-cell whitespace skew in
//     the live, human-edited source sheet — not a Go parsing bug (Go's
//     pricing.Index intentionally does not strip/normalize promo
//     values, matching find_all_promotions_by_sku_and_time's own
//     raw-value behavior exactly) and not reproducible from the frozen
//     snapshot alone.
var knownDivergences_BigC = map[string]bool{
	...
	"2631057733376.pdf:27:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057733376.pdf:32:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774005.pdf:10:AQ":  true, // live-CSV-snapshot newline skew
	"2631057774005.pdf:11:AQ":  true, // live-CSV-snapshot newline skew
	"2631057774005.pdf:9:AQ":   true, // live-CSV-snapshot newline skew
	...
	"2631057774579.pdf:17:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774579.pdf:76:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774693.pdf:105:AQ": true, // live-CSV-snapshot newline skew
	"2631057774693.pdf:108:L":  true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2631057774693.pdf:109:AQ": true, // live-CSV-snapshot newline skew
	...
	"2631057774693.pdf:18:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774693.pdf:25:AQ":  true, // live-CSV-snapshot newline skew
	"2631057774693.pdf:30:AQ":  true, // live-CSV-snapshot newline skew
	"2631057774693.pdf:30:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2631057774693.pdf:31:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774693.pdf:37:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057774693.pdf:59:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837378.pdf:15:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837378.pdf:26:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837522.pdf:11:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837522.pdf:36:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837522.pdf:46:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2631057837522.pdf:70:AQ":  true, // live-CSV-snapshot newline skew
	"2631057837522.pdf:70:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2631057837522.pdf:71:AQ":  true, // live-CSV-snapshot newline skew
	"2631057837522.pdf:72:AQ":  true, // live-CSV-snapshot newline skew
	"2631057837522.pdf:74:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2631057837522.pdf:76:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057860744.pdf:45:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057890077.pdf:12:AQ":  true, // live-CSV-snapshot newline skew
	"2632057890077.pdf:12:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057890077.pdf:13:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057890077.pdf:19:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057890077.pdf:32:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938612.pdf:25:AQ":  true, // live-CSV-snapshot newline skew
	"2632057938612.pdf:25:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938612.pdf:2:AQ":   true, // live-CSV-snapshot newline skew
	"2632057938612.pdf:30:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938612.pdf:34:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938612.pdf:59:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938612.pdf:71:AQ":  true, // live-CSV-snapshot newline skew
	"2632057938612.pdf:72:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938612.pdf:93:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938704.pdf:109:AQ": true, // live-CSV-snapshot newline skew
	"2632057938704.pdf:109:L":  true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938704.pdf:110:AQ": true, // live-CSV-snapshot newline skew
	"2632057938704.pdf:113:L":  true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938704.pdf:11:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938704.pdf:38:AQ":  true, // live-CSV-snapshot newline skew
	"2632057938704.pdf:39:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938704.pdf:45:AQ":  true, // live-CSV-snapshot newline skew
	"2632057938704.pdf:45:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938704.pdf:46:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938704.pdf:61:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938704.pdf:66:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632057938704.pdf:77:AQ":  true, // live-CSV-snapshot newline skew
	"2632057938704.pdf:78:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632057938704.pdf:79:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001889.pdf:24:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001889.pdf:4:AQ":   true, // live-CSV-snapshot newline skew
	...
	"2632058001987.pdf:10:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001987.pdf:19:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:20:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:23:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:23:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632058001987.pdf:24:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:25:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632058001987.pdf:33:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:34:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001987.pdf:73:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001987.pdf:79:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2632058001987.pdf:82:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:83:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:83:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632058001987.pdf:86:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:87:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632058001987.pdf:91:AQ":  true, // live-CSV-snapshot newline skew
	"2632058001987.pdf:91:L":   true, // per-store weight-suffix quirk (xulydonhang.py:4850)
	"2632058001987.pdf:92:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058028372.pdf:19:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058028372.pdf:5:AQ":   true, // live-CSV-snapshot newline skew
	...
	"2633058059999.pdf:20:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058059999.pdf:26:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058059999.pdf:28:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058059999.pdf:48:AQ":  true, // live-CSV-snapshot newline skew
	"2633058059999.pdf:51:AQ":  true, // live-CSV-snapshot newline skew
	...
	"2633058059999.pdf:61:AQ":  true, // live-CSV-snapshot newline skew
	"2633058059999.pdf:62:AQ":  true, // live-CSV-snapshot newline skew
